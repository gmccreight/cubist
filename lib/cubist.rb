...
require_relative 'cubist/docs/link'
require_relative 'cubist/docs/link_to_file_line'
require_relative 'cubist/docs/link_translator'
require_relative 'cubist/docs/links_checker'
